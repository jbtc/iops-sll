...
namespace iOps.Website
{
    public static class awesomeConfigurator
    {
        ...
        {
            if (type == "Form.ConfirmOptions" && key == "Title")
                return "";
            if (type == "Form.ConfirmOptions" && key == "Message")
                return @Mui.confirm_delete;
            if (type == "PopupForm" && key == "Title")
                return "";
            if (type == "Lookup" && key == "Title")
                return "";
            if (type == "MultiLookup" && key == "Title")
                return "";
            switch (key)
            {
                case "CancelText":
