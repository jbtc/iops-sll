...
edit the connection string from Website\web.config 
...
go to properties of \Website\pictures folder and in security tab add full control rights for the IIS_IUSRS
